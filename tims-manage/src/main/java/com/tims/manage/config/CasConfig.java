...
//     */
//    @Bean
//    public FilterRegistrationBean authenticationFilter(SimpleUrlPatternMatcherStrategy simpleUrlPatternMatcherStrategy) {
//        FilterRegistrationBean filterRegistration = new FilterRegistrationBean();
//        AuthenticationFilter authenticationFilter = new AuthenticationFilter();
//        authenticationFilter.setIgnoreUrlPatternMatcherStrategyClass(simpleUrlPatternMatcherStrategy);
